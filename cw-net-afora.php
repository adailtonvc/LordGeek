    ...
    <h2 class="titulo-secao-h2">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            <article>
                ...
                <p class="texto-justificado">
                    ...
                    <a href="./cw-news.php">Veja o vídeo[...]</a>
                </p>
            </article>
        </div>
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            <article>
                ...
                <img src="img/cultura-web/anonymous-face500x334.jpg" class="col-xs-12 img-responsive">
                <p class="texto-justificado ">
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            <article>
                ...
                <img src="img/cultura-web/horror-na-franca500x334.jpg" class="col-xs-12 img-responsive">
                <p class="texto-justificado ">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            <article>
                ...
                <img src="img/cultura-web/uber-bh500x334.jpg" class="col-xs-12 img-responsive">
                <p class="texto-justificado ">
                    Praesent sit amet vestibulum neque. Duis in metus maximus, vestibulum est ac, pulvinar lorem. Suspendisse porta velit orci, eget convallis enim tempor viverra. Suspendisse id vehicula turpis. Nullam dictum ipsum non erat lobortis consequat. <!--Morbi luctus diam velit, id tristique tellus accumsan ut.-->
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            <article>
                ...
                <img src="img/cultura-web/whatsapp500x334.jpg" class="col-xs-12 img-responsive">
                <p class="texto-justificado ">
                    Praesent sit amet vestibulum neque. Duis in metus maximus, vestibulum est ac, pulvinar lorem. Suspendisse porta velit orci, eget convallis enim tempor viverra. Suspendisse id vehicula turpis. Nullam dictum ipsum non erat lobortis consequat. <!--Morbi luctus diam velit, id tristique tellus accumsan ut.-->
        ...
        <div class="col-xs-12 col-sm-6 col-md-6">
            <article>
                ...
                <img src="img/cultura-web/windows-10-500x334.jpg" class="col-xs-12 img-responsive">
                <p class="texto-justificado ">
                    Praesent sit amet vestibulum neque. Duis in metus maximus, vestibulum est ac, pulvinar lorem. Suspendisse porta velit orci, eget convallis enim tempor viverra. Suspendisse id vehicula turpis. Nullam dictum ipsum non erat lobortis consequat. <!--Morbi luctus diam velit, id tristique tellus accumsan ut.-->
