...
<body>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12">
        ...
        <div class="col-xs-12 col-sm-6 col-md-8">
            <article>
                <h3 class="cw-principal-titulo">News - Uber de Belo Horizonte terá opção para usar o serviço para doar água</h3>
                ...
                <img src="img/cultura-web/news-uber500x334.jpg" class="col-xs-12 img-responsive">
